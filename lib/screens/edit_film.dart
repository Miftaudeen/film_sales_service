...
class EditFilm extends StatefulWidget {
  ...
  const EditFilm({Key key, this.film}) : super(key: key);
  @override
  EditFilmState createState() => EditFilmState(this.film);
}

class EditFilmState extends State<EditFilm> {
  final Film film;
  ...
  EditFilmState(this.film);

  @override
  Widget build(BuildContext context) {
    _title = film.title;
    _description = film.description;
    _label = film.label;
    _director = film.director;
    _year = film.year;
    _downloadLink = film.downloadLink;
    _banner = film.banner;
    _genre = film.genre;
    return Scaffold(
      key: scaffoldKey,
